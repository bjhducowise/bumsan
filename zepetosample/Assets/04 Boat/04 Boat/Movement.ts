...
export default class MovingBlock extends ZepetoScriptBehaviour {
    ...
    private Start() {
        ...
        this.rigidbody.velocity = Vector3.op_Multiply(this.moveSpeed,this.moveDirection);
    ...
    */
    private MoveLocalCharacterWithBlock() {
        ...
        let velocity = Vector3.op_Multiply(this.moveSpeed, this.moveDirection);

        this.localCharacterController.Move(Vector3.op_Multiply(velocity ,Time.fixedDeltaTime));
    }
    ...
    */
    private RotateBlock() {
        let deltaRotation: Quaternion = Quaternion.Euler(Vector3.op_Multiply(this.eulerAngleVelocity ,Time.fixedDeltaTime));
        this.rigidbody.MoveRotation(Multiply(this.rigidbody.rotation,deltaRotation));
    }
...
function Multiply(rotation: Quaternion, deltaRotation: Quaternion): Quaternion {
