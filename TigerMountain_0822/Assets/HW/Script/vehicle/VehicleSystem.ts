    ...
    Start() {    
        ...
        ZepetoPlayers.instance.OnAddedLocalPlayer.AddListener(() => {
            ...
            if(this.vehicleOnOff){
                ...
                this.vehilceInstanteObject = this.createVehicleClient(instantiateVector,UnityEngine.Quaternion.LookRotation(UnityEngine.Vector3.back,UnityEngine.Vector3.up));
                //this.vehilceInstanteObject = this.createVehicleClient(instantiateVector,this._player.transform.rotation);
                ...
                //보트 생성 시 플레이어의 방향 설정을 위한 코드 
                this._player.zepetoPlayer.character.gameObject.transform.rotation = UnityEngine.Quaternion.LookRotation(UnityEngine.Vector3.forward,UnityEngine.Vector3.up);//add
